...
public class SetionResetAnim implements FaultAnimation, ParameterChangeListener, UCERF3RupSetChangeListener, FaultColorer {
	...
	public SetionResetAnim(PluginActors pluginActors) {
	...
	public void setCurrentStep(int step) {
		...
		if (step >= 0 && sectCalc != null) {
			...
			double[] areas = sectCalc.getAreaInSectionPolygons(rup.getRuptureSurface());
			if (areas != null) {
				...
				List<FaultSectionPrefData> sects = sectCalc.getMatchingSections(areas);
				if (sects != null) {
