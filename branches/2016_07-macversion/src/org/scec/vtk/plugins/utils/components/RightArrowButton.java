...
public class RightArrowButton extends JButton {
     ...
     */
    public RightArrowButton(ActionListener listener, String tip) {
        super();
        ImageIcon icon    = new ImageIcon(this.getClass().getResource("resources/img/rightArrowIcon.png"));
        ImageIcon iconDis = new ImageIcon(this.getClass().getResource("resources/img/rightArrowIcon.png"));
