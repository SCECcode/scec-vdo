...
import org.scec.geo3d.library.wgcep.surfaces.params.ColorParameter;
...
public class PointSurfaceGenerator extends GeometryGenerator implements ParameterChangeListener {
	...
	private BranchGroup createFaultBranchGroup(EvenlyGriddedSurface surface, Color color, AbstractFaultSection fault) {
		...
		Point3f[] points= new Point3f[numSurfacePoints];
		int cnt = 0;
