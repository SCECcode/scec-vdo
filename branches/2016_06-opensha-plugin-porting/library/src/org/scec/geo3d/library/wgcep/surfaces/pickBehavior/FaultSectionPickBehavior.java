...
public class FaultSectionPickBehavior extends Behavior {
					...
					if (eventId == MouseEvent.MOUSE_PRESSED && events[i] instanceof MouseEvent) {
						...
						if (mouseEvent.getButton() == MouseEvent.BUTTON1) {
							...
							if (this.pickResult != null){
								if(prev!=null)
									prev=null;
								if (this.pickResult.getObject() instanceof FaultSectionShape3D) {
									FaultSectionShape3D faultShape = (FaultSectionShape3D)this.pickResult.getObject();
