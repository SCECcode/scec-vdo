...
public class Eqsimulators extends JFrame
    ...
    public Eqsimulators(ArrayList<String> data, String tableTitle) {
...
//     Run the Mini Browser.
	...
	public static void main(String[] args) {
        Eqsimulators browser = new Eqsimulators(pageList, "Mini Browser");
        browser.show();
    }
}
