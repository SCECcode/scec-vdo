...
public class GraticuleGUI extends JPanel implements ActionListener{
	...
	public static GraticulePreset getGraticlePreset(){
		...
		String calGridPath = Info.getMainGUI().getRootPluginDir() + File.separator + "Grid" + File.separator + "California.grat";
	...
	private JPanel getGridSettingsPanel()
	{
		...
		JLabel userInstructions = new JLabel("Select Scott's Grid Color   ");
		Box bx2 = new Box(0);
