 ...
 */
public class EmptyDownArrowButton extends JButton {
     ...
     */
    public EmptyDownArrowButton(ActionListener listener, String tip) {
        super();
        ImageIcon icon    = new ImageIcon(this.getClass().getResource("resources/img/emptyDownArrowIcon.png"));
        ImageIcon iconDis = new ImageIcon(this.getClass().getResource("resources/img/emptyDownArrowIcon.png"));
