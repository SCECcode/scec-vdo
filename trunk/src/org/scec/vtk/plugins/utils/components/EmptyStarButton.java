 ...
 */
public class EmptyStarButton extends JButton {
     ...
     */
    public EmptyStarButton(ActionListener listener, String tip) {
        super();
        ImageIcon icon    = new ImageIcon(this.getClass().getResource("resources/img/emptyStarIcon.png"));
        ImageIcon iconDis = new ImageIcon(this.getClass().getResource("resources/img/emptyStarIcon.png"));
