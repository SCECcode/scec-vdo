 ...
 */
public class FilledCircleButton extends JButton {
     ...
     */
    public FilledCircleButton(ActionListener listener, String tip) {
        super();
        ImageIcon icon    = new ImageIcon(this.getClass().getResource("resources/img/filledCircleIcon.png"));
        ImageIcon iconDis = new ImageIcon(this.getClass().getResource("resources/img/filledCircleIcon.png"));
