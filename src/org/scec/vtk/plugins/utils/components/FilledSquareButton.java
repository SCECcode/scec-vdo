 ...
 */
public class FilledSquareButton extends JButton {
     ...
     */
    public FilledSquareButton(ActionListener listener, String tip) {
        super();
        ImageIcon icon    = new ImageIcon(this.getClass().getResource("resources/img/filledSquareIcon.png"));
        ImageIcon iconDis = new ImageIcon(this.getClass().getResource("resources/img/filledSquareIcon.png"));
