...
public class UpArrowButton extends JButton {
     ...
     */
    public UpArrowButton(ActionListener listener, String tip) {
        super();
        ImageIcon icon    = new ImageIcon(this.getClass().getResource("resources/img/upArrowIcon.png"));
        ImageIcon iconDis = new ImageIcon(this.getClass().getResource("resources/img/upArrowIcon.png"));
