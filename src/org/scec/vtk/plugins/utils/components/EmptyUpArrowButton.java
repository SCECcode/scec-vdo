 ...
 */
public class EmptyUpArrowButton extends JButton {
     ...
     */
    public EmptyUpArrowButton(ActionListener listener, String tip) {
        super();
        ImageIcon icon    = new ImageIcon(this.getClass().getResource("resources/img/emptyUpArrowIcon.png"));
        ImageIcon iconDis = new ImageIcon(this.getClass().getResource("resources/img/emptyUpArrowIcon.png"));
