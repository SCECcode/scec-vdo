 ...
 */
public class EmptyCircleButton extends JButton {
     ...
     */
    public EmptyCircleButton(ActionListener listener, String tip) {
        super();
        ImageIcon icon    = new ImageIcon(this.getClass().getResource("resources/img/emptyCircleIcon.png"));
        ImageIcon iconDis = new ImageIcon(this.getClass().getResource("resources/img/emptyCircleIcon.png"));
