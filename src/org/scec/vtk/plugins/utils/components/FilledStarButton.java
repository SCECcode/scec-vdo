 ...
 */
public class FilledStarButton extends JButton {
     ...
     */
    public FilledStarButton(ActionListener listener, String tip) {
        super();
        ImageIcon icon    = new ImageIcon(this.getClass().getResource("resources/img/filledStarIcon.png"));
        ImageIcon iconDis = new ImageIcon(this.getClass().getResource("resources/img/filledStarIcon.png"));
